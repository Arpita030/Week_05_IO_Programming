...
class IPLCensorAnalyzerTest {
    ...
    @Test
    void testCensorData() {
        List<IPLMatch> censoredMatches = com.bridgelabz.practice_problem_2.ipl_and_censor_analyzer.IPLCensorAnalyzer.IPLCensorAnalyzer.censorData(sampleMatches);
    ...
    void testCensorCsvData() {
        List<String[]> censoredCsvData = com.bridgelabz.practice_problem_2.ipl_and_censor_analyzer.IPLCensorAnalyzer.IPLCensorAnalyzer.censorCsvData(sampleCsvData);
    ...
    void testCensorTeamName() {
        assertEquals("Mumbai ***", com.bridgelabz.practice_problem_2.ipl_and_censor_analyzer.IPLCensorAnalyzer.IPLCensorAnalyzer.censorTeamName("Mumbai Indians"));
        assertEquals("Delhi ***", com.bridgelabz.practice_problem_2.ipl_and_censor_analyzer.IPLCensorAnalyzer.IPLCensorAnalyzer.censorTeamName("Delhi Capitals"));
        assertEquals("SRH", com.bridgelabz.practice_problem_2.ipl_and_censor_analyzer.IPLCensorAnalyzer.IPLCensorAnalyzer.censorTeamName("SRH")); // No space in team name, should remain unchanged
    }
}
